...
const precache_list = [
	'/dashboard/', // Since the app is CSR, the HTML returned by every route is the same, so we can serve this as a response to every navigate request (initial page load / refresh)
	...build,
	...filteredFiles,
	...prerendered
].map((s) => ({
